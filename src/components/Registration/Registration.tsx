...
const Registration = () => {
    ...
    return (
        <Authentification title="Registration" buttonText={'register'} handler={handleRegistration} linkPath='/login' stylingClass={'registration-login'} reference='Login' buttonName='register'>
