...
const Registration = () => {
    ...
    return (
        <Authentification title="Registration" buttonText={SIGNUP_BUTTON_TEXT} submitHandler={handleRegistration} linkPath='/login' stylingClass={'registration-login'} reference='Login' buttonName="register" buttonRole='button'>
