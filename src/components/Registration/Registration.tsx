...
const Registration = () => {
    ...
    return (
        <Authentification title="Registration" buttonText={SIGNUP_BUTTON_TEXT} handler={handleRegistration} linkPath='/login' stylingClass={'registration-login'} reference='Login' buttonName='register' >
